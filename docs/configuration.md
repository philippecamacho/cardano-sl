...
configuration, `node` configuration. Below we describe each
part. Probably the most important part of `core` configuration is
`genesis` configuration. It's described
